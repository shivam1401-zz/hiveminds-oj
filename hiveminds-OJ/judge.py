...
if "-judge" not in sys.argv:
	print "\nIndeed Hive Mind : Execution Protocol (Linux Version 1.0)";
...
# Print Heading
os.system("clear")
print "\nIndeed Hive Mind : Execution Protocol\n";
...
try:
	...
	while 1: # Infinite Loop
		...
		if cursor.rowcount>0:
			os.system("clear")
			print "\Indeed Hive Mind : Execution Protocol\n";
			...
			if result==None:
				...
				else: shutil.copyfile("io_cache/Indeed Hive Mind - Problem ID "+str(run["pid"])+" - Input.txt","env/input.txt")
			...
			if result==None:
				...
				if "-cache" in sys.argv: 
					run["output"] = file_read("io_cache/Indeed Hive Mind - Problem ID "+str(run["pid"])+" - Output.txt")
...
# Terminate
print "Indeed Hive Mind : Execution Protocol Terminated.\n";
