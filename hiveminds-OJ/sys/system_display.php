...
function display_notice()
{
    ...
    if ($edit) {
        ...
        if (isset($admin["notice"]))
            print stripslashes($admin["notice"]);
    ...
    if (!$edit && $_SESSION["status"] == "Admin")
        echo "<br><center><input type='button' value='Edit Notice' onClick=\"window.location='?display=notice&edit=1';\"></center>";
}
...
{
    include("sys/faq.html");
}
function display_doc()
{
    include("sys/doc.html");
}
